...
message10 = Message.create!(content: "Yay!", user_id: user3.id, conversation_id: conversation1.id)
message11 = Message.create!(content: "Hey Meghan how are things?", user_id: user1.id, conversation_id: conversation1.id)
message12 = Message.create!(content: "Everything is fantastic and wonderful.", user_id: user2.id, conversation_id: conversation1.id)
message13 = Message.create!(content: "It was great having this pretend conversation with you.", user_id: user1.id, conversation_id: conversation1.id)
message14 = Message.create!(content: "Yay!", user_id: user3.id, conversation_id: conversation1.id)
message15 = Message.create!(content: "I wrote a bunch of words.", user_id: user3.id, conversation_id: conversation1.id)
message17 = Message.create!(content: "Where are the fucking conflicts?!", user_id: user2.id, conversation_id: conversation1.id)
message18 = Message.create!(content: "My name is Ethan.", user_id: user7.id, conversation_id: conversation1.id)
message19 = Message.create!(content: "I'm out of juice.", user_id: user6.id, conversation_id: conversation1.id)
